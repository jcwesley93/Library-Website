...
@good_omens = Book.create(title: "Good Omens", num_of_pages: 288)
@good_omens.authors << @neil_gaiman
@good_omens.authors << @terry_pratchett

#reaper man
@reaper_man = Book.create(title: "Reaper Man", num_of_pages: 352, authors: [@terry_pratchett])

#heads you lose
@lisa_lutz = Author.create(name: "Lisa Lutz", birth_year: 1970)
@david_hayward = Author.create(name: "David Hayward", birth_year: 1880)

@heads_you_lose = Book.create(title: "Heads You Lose", num_of_pages: 156)
...
@between_the_lines = Book.create(title: "Between the Lines", num_of_pages: 355)
...
@the_cinderella_murder = Book.create(title: "The Cinderella Murder", num_of_pages: 320)
...
@why_we_broke_up = Book.create(title: "Why We Broke Up", num_of_pages: 384)
...
@dash_lilys_book_of_dares = Book.create(title: "Dash & Lily's Book of Dares", num_of_pages: 257)
...
@relic = Book.create(title: "Relic", num_of_pages: 481)
